...
import com.planeggmobile.proovopengl3.R;
...
public class GameRenderer implements GLSurfaceView.Renderer {
    ...
    private ObjModel objModel;  // .obj mudel
    private int objProgram;     // Shaderi programm .obj jaoks
    ...
    public GameRenderer(Context context) {
        ...
        ObjModel model = new ObjModel(context, R.raw.kolmnurk, new ModelLoadCallback() {
            @Override
            public void onModelLoaded() {
                // Setup OpenGL buffers here after model is loaded
                model.setupBuffers();
            }
        });
        // Lisame .obj mudeli
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        // Logime OpenGL versiooni, et näha, milline versioon töötab
        String version = GLES30.glGetString(GLES30.GL_VERSION);
        Log.i("MK001 OnSurf : OpenGL Version", "Using OpenGL version: " + version);
        ...
        objProgram = createShaderProgram(VERTEX_SHADER_CODE, FRAGMENT_SHADER_CODE_RED);

        if (triangleProgram == 0 || squareProgram == 0 || objProgram == 0) {
            Log.e("GameRenderer", "Shader programmi loomine ebaõnnestus.");
            return;
        }

       // kuna selle teeme onDrawFrames setupTriangleBuffers();
        setupSquareBuffers();
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        {
            if (objModel != null) {
                objModel.setupBuffers();  // Mudeleid saab seadistada siin
            }
        }
        ...
        // Joonistame .obj mudeli
        GLES30.glUseProgram(objProgram);
      //
        drawObjModel();
    ...
    private void drawObjModel() {
        ...
        mvpMatrixHandle = GLES30.glGetUniformLocation(objProgram, "uMVPMatrix");
        GLES30.glUniformMatrix4fv(mvpMatrixHandle, 1, false, mvpMatrix, 0);

        objModel.draw(objProgram);  // Draw the .obj model
    }
